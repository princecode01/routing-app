      ...
      <>
        <section className={styles.home}>
          <div className="container d-flex flex-column align-items-center text-center">
            <img className={`${styles.logo} mb-5`} src={logo} />
            <div>
              <h1 className={`mb-0 ${styles.h1}`}>Start React</h1>
              ...
              <p className={styles.mastheadSubheading}>Graphic Artist - Web Designer - Illustrator</p>
            </div>
